...
/**
 * Servlet implementation class bolumsil
 */
@WebServlet("/bolumsil")
public class bolumsil extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String id = request.getParameter("bolumid");
		...
		try{
	           ...
	           if(insertQuery != 0){
					...
					response.sendRedirect("bolumsil.jsp");
				}
