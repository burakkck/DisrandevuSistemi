  ...
  <div class="row">
  		...
  		<%
			...
			try{
		           ...
		           Connection conn = DriverManager.getConnection(bglntiurl,"root","burak145+");
		            ...
		            String SELECT = "select ad,soyad,id from doktor";
   ...
   <div class="col-md-8">
		...
		<table class="table table-striped">
			<tr>
				<th><h4><label>Doktor Adı</label></h4></th>
				<th ><h4 class="col-sm-offset-8">Sil</h4></th>
			</tr>
			
			 <% while(rs.next()){ %>
			<tr>
				<td><%=rs.getString("doktor.ad")+" "+rs.getString("doktor.soyad") %></td>
				<td>
					<div class="col-sm-offset-7">
					<form action ="doktorsil" accept-charset="UTF-8">
					<input type="hidden" name="doktorid" value="<%=rs.getString("doktor.id") %>" />
					<a href="#"><button class="btn btn-danger" >Sil <i class="glyphicon glyphicon-trash"></i></button></a>
					 </form>
					 <% } %>
					</div>
				</td>	
