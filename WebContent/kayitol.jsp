...
<script>
function kontroll(){
             if(document.forum.tc.value=="") alert("tc kimlik numaranızı giriniz!");
             else if (document.forum.isim.value=="" ) alert("Adinizi giriniz!");
             else if (document.forum.soyad.value=="" ) alert("Soyadinizi giriniz!");
             else if (document.forum.mail.value=="" ) alert("E-mailinizi giriniz!");
             else if (document.forum.telefon.value=="" ) alert("telofon numaranızı giriniz");
             else if (document.forum.parola.value=="" ) alert("parolanızı giriniz");
             else if (document.forum.tparola.value=="" ) alert("parolanızı tekrar giriniz");
             else if (document.forum.parola.value != document.forum.tparola.value ) alert("Sifreler ayni degil!");
             else alert("kayit tamamlandi" ) || document.kayitol.submit()  ;
             return false; 
         } 
</script>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form action="kayitolservlet" method="post" name="forum" class="form-horizontal"
					accept-charset="UTF-8" onsubmit="return kontroll()">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								name="cinsiyet" value="Erkek"> Erkek
							</label> <label class="radio-inline"> <input type="radio"
								name="cinsiyet" value="Kadın"> Kadın
							</label>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select name="gun" id="" class=""><option
								...
								id="month" class=""><option value="0" selected="1">Ay</option>
								...
								id="year" class=""><option value="0" selected="1">Yıl</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="annesoyad"
								placeholder="Şifre Sıfırlama İçin Gerekli..!">
						</div>
					</div>
