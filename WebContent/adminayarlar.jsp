...
String insert = "select kullaniciad,sifre from admin where kullaniciad ='"+kullaniciad+"' ";
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form action="AdminAyarlarServlet" name="form" method="post" class="form-horizontal"
