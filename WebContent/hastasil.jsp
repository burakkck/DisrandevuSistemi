  ...
  <div class="row">
  		...
  		<%
			...
			try{
		           ...
		           Connection conn = DriverManager.getConnection(bglntiurl,"root","burak145+");
		            ...
		            String SELECT = "select ad,soyad,tc from hasta";
   ...
   <div class="col-md-8">
		...
		<table class="table table-striped">
			<tr>
				<th><h4><label>TC Kimlik Numarası</label></h4></th>
				<th><h4><label>Ad Soyad</label></h4></th>
			...
			<tr>
				...
				<td>
					...
					<form action ="hastasil" method="post" accept-charset="UTF-8">
					<input type="hidden" name="hastatc" value="<%=rs.getString("hasta.tc") %>" />
